  ...
  useEffect(() => {
    (async () => {
      const resPeraturan = await Axios.get(
        `${API2_URL}/api/list/peraturan_terkait`
      ).then((res) => res.data.peraturan_terkait);
          ...
          {swiperContent.map((item) => (
            <SwiperSlide>
              <div
                ...
                style={{
                  backgroundImage: `url(https://simwas.inspektorat.banjarkota.go.id/inspektorat_api/images/${item.gambar.replace(
                    " ",
                    "%20"
                  )})`,
                }}
...
//                                 className="w-full h-full bg-center bg-cover"
//                                 style={{
//                                     backgroundImage: `url(https://simwas.inspektorat.banjarkota.go.id/inspektorat_api/images/${item.gambar.replace(' ', '%20')})`
//                                 }}
//                             >
