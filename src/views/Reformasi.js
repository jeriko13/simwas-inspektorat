...
export default function Reformasi() {
  ...
  <div className="container mx-auto px-4">
             {/*  <div className="flex flex-wrap items-center mt-32"> */}
                  ...
                  <img
                        alt="..."
                        src={'https://img.freepik.com/free-vector/team-leader-managing-project_1262-21430.jpg?size=626&ext=jpg'}
                        className="w-full align-middle rounded-t-lg"
                      />
                    <blockquote className="relative p-8 mb-4">
                      <svg
                  ...
                  <img
                        alt="..."
                        src={'https://img.freepik.com/free-vector/hand-drawn-business-ethics_23-2148758815.jpg?size=626&ext=jpg'}
                        className="w-full align-middle rounded-t-lg"
                      />
                    <blockquote className="relative p-8 mb-4">
                      <svg
