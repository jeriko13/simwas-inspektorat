              ...
              >
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-lightBlue-500">
                  <img
                    alt="..."
                    src={
                      "https://img.freepik.com/free-vector/scrum-team-discussing-tasks_1262-19878.jpg?w=740"
                    }
                  ...
                  <blockquote className="relative p-8 mb-4">
                    ...
                    <center>
                      <h4 className="text-xl font-bold text-white">Pembinaan Pengawasan</h4>{" "}
                    </center>
              ...
              >
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-lightBlue-500">
                  <img
                    alt="..."
                    src={
                      "https://img.freepik.com/free-vector/business-people-concept-illustration_52683-34118.jpg?size=626&ext=jpg"
                    }
                    className="w-full align-middle rounded-t-lg"
                  />
                  <blockquote className="relative p-8 mb-4">
                    ...
                    <center>
                      <h4 className="text-xl font-bold text-white">Reformasi Birokrasi</h4>{" "}
                    </center>
                  </blockquote>
                </div>
              </a>
              ...
              >
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-lightBlue-500">
                  <img
                    alt="..."
                    src={
                      "https://img.freepik.com/free-vector/cartoon-online-medical-conference-illustrated_23-2148885785.jpg?size=626"
                    }
                    className="w-full align-middle rounded-t-lg"
                  />
                  <blockquote className="relative p-8 mb-4">
              ...
              >
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-lightBlue-500">
                  <img
                    alt="..."
                    src={
                      "https://img.freepik.com/free-vector/flat-medical-conference-illustrated_23-2148885344.jpg?size=626"
                    }
                    className="w-full align-middle rounded-t-lg"
                  />
                  <blockquote className="relative p-8 mb-4">
                    ...
                    <center>
                      <h4 className="text-xl font-bold text-white">Penegakan Integritas</h4>{" "}
                    </center>
                  </blockquote>
                </div>
              </a>
